...
**Статус:** экспериментальный, `0.x.y`. Первая игра — «Сдвиг» (см.
[docs/game-design/the-shift.md](docs/game-design/the-shift.md)). Ни один API не
стабилен.
...
Управление в игре — только стрелки `LEFT`/`RIGHT`.
